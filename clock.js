...
Clock = function( container ){
    ...
    // Init - Build, draw, and start the clock
    my.init = function(){
    ...
    // Draw the elements of the clock on the canvas
    my.draw = function(){
        ...
        // Draw hands
        my.hands = {
            hour:   draw_hand(0.05, 0.7, 'diamond'),
            minute: draw_hand(0.03, 1.0, 'diamond'),
    ...
    // set_time - Adjust the clock to a particular time
    ...
    my.start = function(){
        my.interval_id = setInterval(function(animation_speed){
            ...
            500,  // Sync time every half-second    
            250   // animation speed
        );
    };
    ...
    var rotate_to = function(hand, clock_position, duration) {
    ...
    var draw_hand = function(width_ratio, length_ratio, style) {
    ...
    // List of Roman numerals (1-indexed for direct mapping)
